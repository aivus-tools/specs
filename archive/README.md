...
Исторические документы, выполнившие свою роль. Хранятся для контекста решений, не для исполнения. Перед использованием сверять с актуальным состоянием кода.

| Файл | Что внутри | Статус |
|---|---|---|
| [AI_REFACTORING_PLAN.md](./AI_REFACTORING_PLAN.md) | План миграции Brief AI v2 → v3 (6 фаз) | Рефакторинг завершён, v3 в проде |
